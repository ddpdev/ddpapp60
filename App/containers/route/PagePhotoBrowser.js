...
const EXAMPLES = [
    {
        ...
        enableGrid: false,
        media: [{
            photo: require('../../images/media/hare-1634318__340.jpg'),
            caption: 'media local image... hare...',
        }],
    }, {
        ...
        media: [{
            photo: require('../../images/media/peacock-1576780__340.jpg'), //'http://farm3.static.flickr.com/2667/4072710001_f36316ddc7_b.jpg',
            selected: true,
            caption: 'image image image...',
        }, {
            photo: require('../../images/media/grizzly-1640452__340.jpg'),
            caption: 'grizzly Scene',
        }, {
            photo: require('../../images/media/sun-1654458__340.jpg'), //'http://farm3.static.flickr.com/2449/4052876281_6e068ac860_b.jpg',
            thumb: require('../../images/media/hoverfly-1484870__340.jpg'), // 'http://farm3.static.flickr.com/2449/4052876281_6e068ac860_q.jpg',
            selected: false,
...
class PagePhotoBrowser extends Component {
...
export default connect()(PagePhotoBrowser);
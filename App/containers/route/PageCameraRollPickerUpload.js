...
class PageCameraRollPicker extends Component {
  ...
  doUpload(selectImages){
    ...
    console.log("doUpload:",selectImages.length,",",selectFiles);
    let dirName = "";
    let fileName = "";
    let extName = "";
    let srcFile = "";
    ...
    if( selectImages.length > 0) {
      ...
      let opts = {
        url: UPLOAD_URL, //'http://my.server/api/upload',
        files: files,
        ...
        params: { 'user_id': 'ddpapp_user01' },                   // optional, Android support this only string. If you want this in Android use params: { 'user_id': '1' }
      };

      console.log("upload files:",files, opts);
